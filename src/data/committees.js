...
export const committees = [
  ...
  },
  {
    ...
    emoji: '📢',
    lead: 'Sharmishta',
    coLead: 'Rajasimha Karanam · Santanu Malik',
...
export const stateChampions = [
  ...
  { state: 'Gujarat (Ahmedabad / Vadodara)', champions: [], status: 'open', note: '' },
  { state: 'Rajasthan (Jaipur)', champions: [], status: 'open', note: '' },
  { state: 'Andhra Pradesh / Telangana (Hyderabad / Vizag)', champions: [], status: 'open', note: '' },
  { state: 'Delhi NCR', champions: [], status: 'open', note: '' },
  { state: 'Punjab / Haryana', champions: [], status: 'open', note: '' },
  { state: 'Uttar Pradesh (Lucknow / Noida)', champions: [], status: 'open', note: '' },
  { state: 'Central India (MP / Chhattisgarh)', champions: [], status: 'open', note: '' },
  { state: 'West Bengal (Kolkata)', champions: [], status: 'open', note: '' },
  { state: 'Bihar / Jharkhand (Patna / Ranchi)', champions: [], status: 'open', note: '' },
  { state: 'Odisha (Bhubaneswar)', champions: [], status: 'open', note: '' },
  { state: 'Assam & North-East (Guwahati)', champions: [], status: 'open', note: 'Regional coordination for the North-East' },
