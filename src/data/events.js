...
export const eventSchedule = [
  ...
  { id: 'evt-d1-01', title: 'Check-in to Respective Hotels', description: 'Settle in at your own hotel — rooms are usually ready around noon.', day: 1, date: '2026-12-27', startTime: '', endTime: '', venue: 'Respective hotels', category: 'social', icon: '🏨', isFeatured: false },
  { id: 'evt-d1-02', title: 'Registration Desk for REConverge 2026', description: 'Collect your registration kit — souvenir kit + badge — and complete event check-in.', day: 1, date: '2026-12-27', startTime: '16:00', endTime: '17:30', venue: 'Malabar Palace', category: 'ceremony', icon: '📋', isFeatured: false },
  { id: 'evt-d1-04', title: 'Welcome Address & Housekeeping Brief', description: 'Short welcome from the OCC with a quick walkthrough of the two-day plan.', day: 1, date: '2026-12-27', startTime: '17:30', endTime: '18:00', venue: 'Malabar Palace', category: 'ceremony', icon: '🎤', isFeatured: false },
  { id: 'evt-d1-05', title: 'Ice-Breaker & Cultural Evening by Batchmates', description: 'Performances from the batch — Bakwas Stories, music, and the nostalgia AV to kick off the reunion. Senior batch feedback: "give this more time".', day: 1, date: '2026-12-27', startTime: '18:00', endTime: '21:30', venue: 'Malabar Palace', category: 'cultural', icon: '🎭', isFeatured: true },
  ...
  { id: 'evt-d2-02', title: 'Shuttle Buses Depart to REC', description: 'Buses leave the hotels for campus — more information to follow.', day: 2, date: '2026-12-28', startTime: '08:30', endTime: '09:30', venue: 'From the hotels', category: 'social', icon: '🚌', isFeatured: false },
  { id: 'evt-d2-03', title: 'Gate Welcome, Campus Tour, Procession & Batch Photos', description: 'Traditional welcome at the gate followed by a walk through the campus and new departments — with the batch photos.', day: 2, date: '2026-12-28', startTime: '10:00', endTime: '11:00', venue: 'NITC Campus', category: 'campus', icon: '🚶', isFeatured: true },
  ...
  { id: 'evt-d2-08', title: 'Red-Carpet Entry & Photos', description: 'Themed entry at the banquet hall with photo moments.', day: 2, date: '2026-12-28', startTime: '18:00', endTime: '18:30', venue: 'Hotel Banquet Hall', category: 'campus', icon: '📸', isFeatured: true },
  ...
  { id: 'evt-d3-03', title: 'Hotel Check-out', description: 'Checkout by 12:00 — no planned activities on the 29th. Breakfast per your own hotel reservation.', day: 3, date: '2026-12-29', startTime: '12:00', endTime: '', venue: 'Respective hotels', category: 'social', icon: '👋', isFeatured: false },
];
