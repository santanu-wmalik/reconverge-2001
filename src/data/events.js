...
//
// Aug 2026 tweaks per Sharmishta's review:
//   - Day-1 relabeled "Day 0" (informal check-in / ice-breaker only)
//   - Removed: airport/rail pickups, high tea, batch-story slot, MC line
//   - Day-2 procession description simplified (no Kathakali / bus mentions)

export const eventSchedule = [
  // Day 0 - December 27, 2026 (Check-in & Ice-Breaker)
  ...
  { id: 'evt-d2-01', title: 'Breakfast @ Gokulam Grand', description: 'Buffet breakfast (included with the room).', day: 2, date: '2026-12-28', startTime: '07:00', endTime: '09:00', venue: 'Gokulam Grand', category: 'social', icon: '☕', isFeatured: false },
  ...
  { id: 'evt-d3-01', title: 'Breakfast Brunch with Open Mic', description: 'Long breakfast with short reflections — whoever wants to say something grabs the mic.', day: 3, date: '2026-12-29', startTime: '08:00', endTime: '11:00', venue: 'Hotel Dining', category: 'social', icon: '🎙️', isFeatured: true },
...
export const eventDays = [
  { day: 1, date: '2026-12-27', label: 'Day 0 - Dec 27', subtitle: 'Check-in & Ice-Breaker' },
  { day: 2, date: '2026-12-28', label: 'Day 1 - Dec 28', subtitle: 'Campus & Gala' },
  { day: 3, date: '2026-12-29', label: 'Day 2 - Dec 29', subtitle: 'Departure' },
];
