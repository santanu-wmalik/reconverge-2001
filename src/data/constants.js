...
export const FAQ_DATA = [
  ...
  // === Event & Program ===
  { id: 'f-evt-1', question: 'Is there a dress code?', category: 'Event', answer: 'Yes — each segment has its own theme. The Gala Dinner theme is being polled across five options: Black & Gold · Wine & Black · Bollywood · Retro (70s / 90s) · Indian Formal. The campus day (Day 2) is smart-casual. Theme will be announced ahead of the event.' },
