...
export const planningLog = [
  ...
  },
  {
    ...
    internalNotes: 'Civil: Sinu & Suhailah; CS: Prith & Rajasimha; EEE: Richen, Anu & Sundar; Prod: Nitish & Hari; Mech: Mathew & Robin. Yagya Dutt (junior, trip organiser) recommended for post-event Kerala tour planning.',
...
export const outreachStats = [
  ...
  { branch: 'Computer Science & Engineering', inGroup: '~40% of branch', status: 'Growing', reps: ['Prith', 'Rajasimha'], notes: 'Group created 23 Jan 2026.' },
...
export const actionItems = [
  ...
  { id: 'ai-08', task: 'Contact Yagya Dutt for post-event Kerala tour options', assignee: 'Prith', priority: 'low', status: 'open' },
