...
export const hotels = [
  {
    ...
    tier: 'primary',
    status: 'Fully booked — all 52 rooms in the batch block are taken',
    ...
    bookingMethod: 'The Gokulam Grand block is FULLY BOOKED. Contact the AFC via the group WhatsApp/email to join the waitlist for cancellations, or book one of the backup hotels below.',
  },
  {
    id: 'tiara-mps',
    name: 'Tiara by MPS',
    ...
    badge: 'Backup option',
    amenities: [],
    bookingMethod: 'The Gokulam Grand block is now full — this is the primary overflow option. Contact AFC for the latest rates and availability.',
  },
  {
    id: 'raviz-calicut',
